...
public class Level : MonoBehaviour
{
    ...
    private void Init()
    {
        logger = GameObject.Find("LevelsLogger").GetComponent<Logger>();
    }
    ...
    {
        logger.Log("Pressed! Go To level: " + levelNumber, this);
    ...
    public void ChangeStars(int numStars)
    {
        ...
        {
            logger.Log("Invalid number of stars: " + numStars, this);
            return;
        }
