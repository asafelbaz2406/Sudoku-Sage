...
public class SavingSystem : MonoBehaviour
{
    ...
    static public SavingSystem Instance => instance;
    ...
    private IEnumerator CopyLevelsDataIfNotExists()
    {
        ...
        string sourcePath = Path.Combine(Application.streamingAssetsPath, "sudokuDataContainers.json");
    ...
    {
        string JSON_LEVEL_DICT = JsonConvert.SerializeObject(levelStarsDic, Formatting.Indented);
    ...
    public Dictionary<int, int> LoadLevelDictionary()
    {
        ...
        {
            string json = File.ReadAllText(LEVEL_DICT_FILE_PATH);
